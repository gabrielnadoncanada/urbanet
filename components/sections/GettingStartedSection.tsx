    ...
    <section className="py-8 lg:py-24 px-4 lg:px-12 bg-background">
      <div className="max-w-8xl mx-auto">
        <div className="text-center mb-8 lg:mb-16">
          <h2 className="text-4xl lg:text-5xl font-semibold text-foreground">Getting Started with Urbanet</h2>
        </div>
            ...
            <React.Fragment key={index}>
              <Card className="bg-secondary p-4 lg:p-6 w-full lg:max-w-xs">
                <CardContent className="p-0">
                  <CardTitle className="text-sm lg:text-base font-semibold text-foreground mb-2">{step.title}</CardTitle>
                  <CardDescription className="text-xs lg:text-sm">{step.description}</CardDescription>
                </CardContent>
              </Card>
              {index < 3 && (
